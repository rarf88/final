...
export class LoginComponent{
  ...
  onSubmit(){
    ...
    this.auth.login(this.form.value).subscribe({ next: ()=> this.router.navigateByUrl('/dashboard'), error: (err)=>{ this.errorMsg = (err?.error?.message) || 'Correo o contraseña inválidos'; } });
  }
}
